...
var $author$project$Main$headNeck = F3(
	function (color, size, neckLength) {
		return $evancz$elm_playground$Playground$group(
			_List_fromArray(
				[
					A2($evancz$elm_playground$Playground$circle, color, size),
					A2(
					...
					A2(
						...
						size * (neckLength / 2),
						A3($evancz$elm_playground$Playground$rectangle, color, size, size * neckLength)))
				]));
	});
...
var $author$project$Main$face = $evancz$elm_playground$Playground$group(
	_List_fromArray(
		[
			A3(
			...
			10,
			10,
			A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$black, 15)),
			A3(
			$evancz$elm_playground$Playground$move,
			25,
			-25,
			A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$white, 10)),
			A2(
			$evancz$elm_playground$Playground$moveLeft,
			10,
			A2(
				...
				60,
				A3($author$project$Main$headNeck, $evancz$elm_playground$Playground$orange, 10, 3)))
		]));
...
var $author$project$Main$head = function (nod) {
	return $evancz$elm_playground$Playground$group(
		_List_fromArray(
			[
				A3($author$project$Main$headNeck, $evancz$elm_playground$Playground$yellow, 40, 10),
				A2($evancz$elm_playground$Playground$rotate, nod, $author$project$Main$face)
			]));
};
var $evancz$elm_playground$Playground$brown = $evancz$elm_playground$Playground$Hex('#c17d11');
var $author$project$Main$spot = A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$brown, 12);
var $author$project$Main$spots = function (range) {
	return $evancz$elm_playground$Playground$group(
		A2(
			$elm$core$List$map,
			function (_v0) {
				var x = _v0.a;
				var y = _v0.b;
				return A3($evancz$elm_playground$Playground$move, x, y, $author$project$Main$spot);
			},
			range));
};
var $author$project$Main$giraffe = function (nod) {
	return $evancz$elm_playground$Playground$group(
		_List_fromArray(
			[
				$author$project$Main$head(nod),
				A3(
				$evancz$elm_playground$Playground$move,
				-30,
				-150,
				$author$project$Main$spots(
					_List_fromArray(
						[
							_Utils_Tuple2(2, 0),
							_Utils_Tuple2(18, 28),
...
var $evancz$elm_playground$Playground$wave = F4(
	function (lo, hi, period, time) {
		return lo + (((hi - lo) * (1 + $elm$core$Basics$cos(
			$elm$core$Basics$turns(
				A2($evancz$elm_playground$Playground$toFrac, period, time))))) / 2);
	});
var $author$project$Main$view = function (time) {
	return _List_fromArray(
		[
			A2(
			$evancz$elm_playground$Playground$moveUp,
			A4($evancz$elm_playground$Playground$wave, -50, 150, 4, time),
			A2(
				$evancz$elm_playground$Playground$moveRight,
				A4($evancz$elm_playground$Playground$wave, 0, 100, 10, time),
				$author$project$Main$giraffe(
					A4($evancz$elm_playground$Playground$wave, 10, 70, 3, time))))
		]);
};
